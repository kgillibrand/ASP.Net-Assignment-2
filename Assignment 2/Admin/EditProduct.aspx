<%@ Page Title="Edit Product (Admin) - Kieran's Student Technological Store" Language="C#" MasterPageFile="~/Admin/MasterPageAdminMenu.Master" AutoEventWireup="true" CodeBehind="EditProduct.aspx.cs" Inherits="Assignment_2.Admin.EditProduct" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style = "text-align: center;">
        <div style = "width: 100%; margin-left: auto; margin-right: auto;" class="w3-container w3-border w3-hover-border-blue">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID = "categories" runat = "server" ToolTip = "Select a Category" Width = "30%">
                        </asp:DropDownList>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID = "name" runat = "server" TextMode = "SingleLine" Width = "30%">
                        </asp:TextBox>
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID = "shortDescription" runat ="server" TextMode = "MultiLine" Width = "600px" Height = "15%">
                        </asp:TextBox>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID = "longDescription" runat = "server" TextMode = "MultiLine" Width = "600px" Height = "30%">
                        </asp:TextBox>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID = "price" runat = "server" TextMode = "SingleLine" Width = "20%">
                        </asp:TextBox>
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID = "salePrice" runat = "server" TextMode = "SingleLine" Width = "20%">
                        </asp:TextBox>
                    </td>
                    <td>
